    ...
    <div className="flex items-center gap-3">
      {shareLinks.map((link) => (
        <a
          ...
          className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1.5 text-xs font-medium text-white/70 hover:text-white hover:border-white/20 transition-colors"
        >
          {link.icon}
