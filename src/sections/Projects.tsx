      ...
      <div className="container">
        ...
        <div className="flex flex-col mt-10 md:mt-20 gap-20 ">
          {portfolioProjects.map((project) => (
            <Card
              key={project.title}
              className="px-8 pt-8 md:pt-12 md:px-12 lg:pt-16 lg:px-20 sticky top-0"
            >
              <div className="lg:grid lg:grid-cols-2 gap-16">
                <div className="lg:pb-16">
                  ...
                  <Link href={project.link}>
                    <button className="bg-white text-gray-950 h-12 w-full md:w-auto px-6 rounded-xl font-semibold inline-flex items-center justify-center gap-8 mt-8">
